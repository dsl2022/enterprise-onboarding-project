...
| [CR-20260630-0007](CR-20260630-0007-v1-assistant-rung1-contract-tools-audit.md) | 2026-06-30 00:07 EDT | ADR-0023 (assistant Rung 1) | reconcile frozen chat contract + re-derive tools per request-type + split audit routing | Items 2 & 3 Applied (v1.1.0, 2026-07-06); R1 provenance open (ADR-0024) |
